        ...
        if(pNumber1){
            ...
            .then((response) => {
                if(response.status === 200){
                    ...
                    let __url1 = `${url}cards-api/v1.0/cards`
                    axios.get(`${__url1}`, {headers: headers})
                    .then((response) => {
                        this.props.dispatch(addCard(response.data));
                    })
                    .catch((error) => {
    ...
    handleAddCard () {
        ...
        if(realN && realE && realT && pNumber1){
            ...
            if(data.cardProduct === 'Visa'){
                ...
                axios.post(`${__url}`, JSON.stringify(data1), {headers: headers})
                        .then((response) => {
    ...
    render() {
        return (
            <div>
                ...
                <h3 className="text-5 font-weight-400 mb-4">{Languages.page.cabinet_main[this.props.language].t5}</h3>
                <div className="row">
                ...
                {this.props.cards && 
                        ...
                        {this.props.cards.map((element, i) => {
                            return (
                                <>
                                    ...
                                    {(element.confirmedByOwner || element.cardProduct.name === "Visa") && 
                                        <div key={element.id} className="col-12 col-sm-6 col-lg-4 pb-4">
                                            <div className={`account-card account-card-primary  text-white rounded p-3 mb-4 mb-lg-0`}>                        
                                                ...
                                                <p className="d-flex align-items-center">
                                                <span className="text-3 opacity-9 text-white">{element.cardProduct.name === "Visa" ? 'USD' : element.balance.toLocaleString().split(',').join(' ')} {element.currencyCode}</span> {element.isMainCard ? <span className="bg-light text-0 text-body font-weight-500 rounded-pill d-inline-block px-2 line-height-4 opacity-8 ml-auto">Primary</span> : <span className="bg-light text-0 text-body font-weight-500 rounded-pill d-inline-block px-2 line-height-4 opacity-8 ml-auto">Secondary</span>} </p>
                                                <p className="d-flex align-items-center m-0"> <span className="text-uppercase font-weight-500 text-white">{element.name}</span> <img className={`ml-auto resize-logo-${element.cardProduct.name}`} src={`./../../images/${element.cardProduct.name}.png`} alt="visa"  /> </p>
                                                <div className="account-card-overlay rounded"> <a onClick={e => this.handleCardIsMain(element.isMainCard, element.name)} data-target={`#edit-card-details-${element.id}`} data-toggle="modal" className="text-light btn-link mx-2"><span className="mr-1"><i className="fas fa-edit" /></span>{Languages.page.cabinet_main[this.props.language].t8}</a> <a onClick={e=>this.handleDeleteCard(e, `${element.id}`)} className="text-light btn-link mx-2"><span className="mr-1"><i className="fas fa-minus-circle" /></span>{Languages.page.cabinet_main[this.props.language].t9}</a> </div>
                                            </div>
                                        </div>
                                    }
                        ...
                        {this.props.cards.map((element, i) => {
                            return (
                                <>
                                    ...
                                    {(element.confirmedByOwner === false && element.cardProduct.name !== "Visa") ?
                                        <div key={element.id} className="col-12 col-sm-6 col-lg-4 pb-4">
                                            <div className="account-card text-white rounded p-3 mb-4 mb-lg-0">
                                                ...
                                                <div className="account-card-overlay rounded"> <a data-target="#edit-card-details" onClick={e => this.handleActivateCard(element.id, element.ownerPhoneNumber, element.cardNumber)} data-toggle="modal" className="text-light btn-link mx-2"><span className="mr-1"><i className="fas fa-chevron-up" /></span>Activate</a> <a className="text-light btn-link mx-2" onClick={e => this.handleDeleteCard(e, element.id)}><span className="mr-1"><i className="fas fa-minus-circle" /></span>Delete</a> </div>
                                            </div>
                                        </div>
                                        :
                                        ''
                    ...
                    <div className="col-12 col-sm-6 col-lg-4"> <a data-target="#add-new-card-details" data-toggle="modal" className="account-card-new d-flex align-items-center rounded h-100 p-3 mb-4 mb-lg-0">
                        <p className="w-100 text-center line-height-4 m-0"> <span className="text-3"><i className="fas fa-plus-circle" /></span> <span className="d-block text-body text-3">{Languages.page.cabinet_main[this.props.language].t17}</span> </p>
                    </a> </div>
                </div>
                </div>
                                ...
                                <>
                                    ...
                                    <div className="modal-dialog modal-dialog-centered" role="document">
                                        ...
                                        <div className="modal-header">
                                            <h5 className="modal-title font-weight-400">{Languages.page.cabinet_main[this.props.language].t10}</h5>
                                        ...
                                        <div className="modal-body p-4">
                                            ...
                                            <div className="form-group">
                                                <label htmlFor="edircardNumber">{Languages.page.cabinet_main[this.props.language].t11}</label>
                                            ...
                                            <div className="form-row">
                                                ...
                                                <div className="form-group">
                                                    <label htmlFor="editexpiryDate">{Languages.page.cabinet_main[this.props.language].t12}</label>
                                            ...
                                            <div className="form-row">
                                                <div className="col-lg-6">
                                                    <div className="form-check custom-control custom-checkbox">
                                                        ...
                                                        <label className="custom-control-label" htmlFor="remember">{Languages.page.cabinet_main[this.props.language].t13}</label>
                                                    </div>
                                                </div>
                                                <div className="col-lg-6 pb-2">
                                                    <div className="form-check custom-control custom-checkbox">
                                                        ...
                                                        <label className="custom-control-label" htmlFor="remember-me">{Languages.page.cabinet_main[this.props.language].t14}</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="form-group">
                                                <label htmlFor="editcardHolderName">{Languages.page.cabinet_main[this.props.language].t15}</label>
                                            ...
                                            <a className="btn btn-primary btn-block text-white card-add-f-btn" id={`${element.id}`} onClick={this.handleCardUpdate} data-dismiss="modal">{Languages.page.cabinet_main[this.props.language].t16}</a>
                ...
                <div className="modal-dialog modal-dialog-centered" role="document">
                    <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title font-weight-400">{Languages.page.cabinet_main[this.props.language].t17}</h5>
                        <button type="button" className="close font-weight-400" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
                    </div>
                    <div className="modal-body p-4">
                        ...
                        <div className="form-group">
                            <label htmlFor="cardNumber">{Languages.page.cabinet_main[this.props.language].t11}</label>
                            <input type="text" className="form-control" data-bv-field="cardnumber" id="cardNumber" required maxLength="19" onChange={(e) => this.handleCardNumber(e)} pattern="^[0-9]{16}$" placeholder={Languages.page.cabinet_main[this.props.language].t11} />
                        </div>
                        <div className="form-row">
                            <div className="col-lg-6">
                            <div className="form-group">
                                <label htmlFor="expiryDate">{Languages.page.cabinet_main[this.props.language].t12}</label>
                        ...
                        <div className="form-group">
                            <label htmlFor="cardHolderName">{Languages.page.cabinet_main[this.props.language].t15}</label>
                            <input type="text" className="form-control" data-bv-field="cardholdername" id="cardHolderName" maxLength="26" onChange={(e) => this.handleCardName(e)} placeholder={Languages.page.cabinet_main[this.props.language].t15} />
                        </div>
                        <a className="btn btn-primary btn-block card-add-f-btn text-white" onClick={this.handleAddCard} data-toggle="modal" type="submit">{Languages.page.cabinet_main[this.props.language].t18}</a>
                ...
                <div className="modal-dialog modal-dialog-centered" role="document">
                    <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title font-weight-400">{Languages.page.cabinet_main[this.props.language].t19}</h5>
                        <button type="button" className="close font-weight-400" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
                    </div>
                    <div className="modal-body p-4">
                        <form id="addCard" method="post">
                        ...
                        <div className="form-group">
                            <label htmlFor="cardNumber">{Languages.page.cabinet_main[this.props.language].t20}</label>
                            <input type="text" className="form-control" data-bv-field="cardnumber" id="cardNumber" disabled="true" value={this.handleShowPhNum()}/>
                        </div>
                        <div className="form-row">
                            <div className="col-lg-6">
                            <div className="form-group">
                                <label htmlFor="expiryDate">{Languages.page.cabinet_main[this.props.language].t21}</label>
                                <input id="expiryDate" type="text" onChange={this.handleSmsValue} className="form-control" maxLength="4" placeholder="----" pattern="^[0-9]{4}$" />
                            </div>
                            </div>
                        </div>
                        <a className="btn btn-primary btn-block card-add-f-btn text-white" onClick={(e) => this.handleSmsCode(e)} type="submit">{Languages.page.cabinet_main[this.props.language].t22}</a>
