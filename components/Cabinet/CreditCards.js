    ...
    render() {
        return (
            <div>
                ...
                <h3 className="text-5 font-weight-400 mb-4">{Languages.page.cabinet_main.Уз_уз.t5}</h3>
                <div className="row">
                ...
                {this.props.cards && 
                    ...
                    <div className="col-12 col-sm-6 col-lg-4"> <a data-target="#add-new-card-details" data-toggle="modal" className="account-card-new d-flex align-items-center rounded h-100 p-3 mb-4 mb-lg-0">
                        <p className="w-100 text-center line-height-4 m-0"> <span className="text-3"><i className="fas fa-plus-circle" /></span> <span className="d-block text-body text-3">{Languages.page.cabinet_main.Уз_уз.t17}</span> </p>
                    </a> </div>
                </div>
                </div>
                                ...
                                <>
                                    ...
                                    <div className="modal-dialog modal-dialog-centered" role="document">
                                        ...
                                        <div className="modal-header">
                                            <h5 className="modal-title font-weight-400">{Languages.page.cabinet_main.Уз_уз.t10}</h5>
                                        ...
                                        <div className="modal-body p-4">
                                            ...
                                            <div className="form-group">
                                                <label htmlFor="edircardNumber">{Languages.page.cabinet_main.Уз_уз.t11}</label>
                                            ...
                                            <div className="form-row">
                                                ...
                                                <div className="form-group">
                                                    <label htmlFor="editexpiryDate">{Languages.page.cabinet_main.Уз_уз.t12}</label>
                                            ...
                                            <div className="form-row">
                                                <div className="col-lg-6">
                                                    <div className="form-check custom-control custom-checkbox">
                                                        ...
                                                        <label className="custom-control-label" htmlFor="remember">{Languages.page.cabinet_main.Уз_уз.t13}</label>
                                                    </div>
                                                </div>
                                                <div className="col-lg-6 pb-2">
                                                    <div className="form-check custom-control custom-checkbox">
                                                        ...
                                                        <label className="custom-control-label" htmlFor="remember-me">{Languages.page.cabinet_main.Уз_уз.t14}</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="form-group">
                                                <label htmlFor="editcardHolderName">{Languages.page.cabinet_main.Уз_уз.t15}</label>
                                            ...
                                            <a className="btn btn-primary btn-block text-white card-add-f-btn" id={`${element.id}`} onClick={this.handleCardUpdate} data-dismiss="modal">{Languages.page.cabinet_main.Уз_уз.t16}</a>
                ...
                <div className="modal-dialog modal-dialog-centered" role="document">
                    <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title font-weight-400">{Languages.page.cabinet_main.Уз_уз.t17}</h5>
                        <button type="button" className="close font-weight-400" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
                    </div>
                    <div className="modal-body p-4">
                        ...
                        <div className="form-group">
                            <label htmlFor="cardNumber">{Languages.page.cabinet_main.Уз_уз.t11}</label>
                            <input type="text" className="form-control" data-bv-field="cardnumber" id="cardNumber" required maxLength="19" onChange={(e) => this.handleCardNumber(e)} pattern="^[0-9]{16}$" placeholder={Languages.page.cabinet_main.Уз_уз.t11} />
                        </div>
                        <div className="form-row">
                            <div className="col-lg-6">
                            <div className="form-group">
                                <label htmlFor="expiryDate">{Languages.page.cabinet_main.Уз_уз.t12}</label>
                        ...
                        <div className="form-group">
                            <label htmlFor="cardHolderName">{Languages.page.cabinet_main.Уз_уз.t15}</label>
                            <input type="text" className="form-control" data-bv-field="cardholdername" id="cardHolderName" maxLength="26" onChange={(e) => this.handleCardName(e)} placeholder={Languages.page.cabinet_main.Уз_уз.t15} />
                        </div>
                        <a className="btn btn-primary btn-block card-add-f-btn text-white" onClick={this.handleAddCard} data-toggle="modal" type="submit">{Languages.page.cabinet_main.Уз_уз.t18}</a>
                ...
                <div className="modal-dialog modal-dialog-centered" role="document">
                    <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title font-weight-400">{Languages.page.cabinet_main.Уз_уз.t19}</h5>
                        <button type="button" className="close font-weight-400" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
                    </div>
                    <div className="modal-body p-4">
                        <form id="addCard" method="post">
                        ...
                        <div className="form-group">
                            <label htmlFor="cardNumber">{Languages.page.cabinet_main.Уз_уз.t20}</label>
                            <input type="text" className="form-control" data-bv-field="cardnumber" id="cardNumber" disabled="true" value={this.handleShowPhNum()}/>
                        </div>
                        <div className="form-row">
                            <div className="col-lg-6">
                            <div className="form-group">
                                <label htmlFor="expiryDate">{Languages.page.cabinet_main.Уз_уз.t21}</label>
                                <input id="expiryDate" type="text" onChange={this.handleSmsValue} className="form-control" maxLength="4" placeholder="----" pattern="^[0-9]{4}$" />
                            </div>
                            </div>
                        </div>
                        <a className="btn btn-primary btn-block card-add-f-btn text-white" onClick={(e) => this.handleSmsCode(e)} type="submit">{Languages.page.cabinet_main.Уз_уз.t22}</a>
